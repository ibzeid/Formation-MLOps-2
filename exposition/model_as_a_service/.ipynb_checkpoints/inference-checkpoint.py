...
def predict_endpoint():
    ...
    ws1_avg_value = float(received_wind_speed_avg)

    received_data_df = pd.DataFrame({"Wind_turbine_name": "R80721", "Date_time": "2017-02-08T08:00:00+01:00", "Ba_avg": 44.99, "Ba_min": 44.99,
     ...
     "Wa_c_max": None, "Wa_c_std": None, "Na_c_avg": 358.04, "Na_c_min": None, "Na_c_max": None, "Na_c_std": None},index=[0])
